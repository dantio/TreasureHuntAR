var Solar = {
    ...
    init: function() {
        ...
        var sunImg = new AR.ImageResource("img/treasure.png");
        var mercuryImg = new AR.ImageResource("img/treasure.png");
        var venusImg = new AR.ImageResource("img/treasure.png");
        var earthImg = new AR.ImageResource("img/treasure.png");
        var marsImg = new AR.ImageResource("img/treasure.png");
        var jupiterImg = new AR.ImageResource("img/treasure.png");
        var saturnImg = new AR.ImageResource("img/treasure.png");
        var uranusImg = new AR.ImageResource("img/treasure.png");
        var neptuneImg = new AR.ImageResource("img/treasure.png");
        var plutoImg = new AR.ImageResource("img/treasure.png");
